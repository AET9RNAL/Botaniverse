...
public abstract class RenderSparkAlfheimBase<T extends Entity> extends Render<T> {

    public RenderSparkAlfheimBase(RenderManager manager) {
        super(manager);
    }
    ...
    protected TextureAtlasSprite getBaseIcon(T entity) {
        return MiscellaneousIcons.INSTANCE.sparkWorldIconAlfheim;
    }
