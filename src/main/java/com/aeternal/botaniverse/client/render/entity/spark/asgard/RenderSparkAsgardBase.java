...
public abstract class RenderSparkAsgardBase<T extends Entity> extends Render<T> {

    public RenderSparkAsgardBase(RenderManager manager) {
        super(manager);
    }
    ...
    protected TextureAtlasSprite getBaseIcon(T entity) {
        return MiscellaneousIcons.INSTANCE.sparkWorldIconAsgard;
    }
