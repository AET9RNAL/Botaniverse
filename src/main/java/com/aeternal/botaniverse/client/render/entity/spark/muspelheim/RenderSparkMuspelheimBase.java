...
public abstract class RenderSparkMuspelheimBase<T extends Entity> extends Render<T> {

    public RenderSparkMuspelheimBase(RenderManager manager) {
        super(manager);
    }
    ...
    protected TextureAtlasSprite getBaseIcon(T entity) {
        return MiscellaneousIcons.INSTANCE.sparkWorldIconMuspelheim;
    }
